...
![Continuous Integration](https://github.com/hackariens/react/workflows/ci/badge.svg?branch=develop)
...
```sh
git clone --recurse-submodules git@github.com:hackariens/react.git react
cd react
```
